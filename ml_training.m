...
initial_bagged_trees_model = fitcensemble( ...
    predictors, response, ...
    'method', 'bag', ...
...
trained_classifier.predict_fn = @(x) predict( initial_bagged_trees_model, x );
trained_classifier.predictor_variable_names = predictor_variable_names;
trained_classifier.model = initial_bagged_trees_model;
...
export_fig( fh, 'initial_bagged_trees_model_roc.png' );
...
writetable( cm, 'initial_bagged_trees_model_confmat.csv' );
